...
docker cp ../sr_arm_hand_test/test_world.world dexterous_hand_simulated:home/user/projects/shadow_robot/base/src/common_resources/sr_description_common/worlds
...
docker exec -ti --user user -w /home/user dexterous_hand_simulated /bin/bash -c "python3.8 -m pip install mediapipe pandas seaborn"
